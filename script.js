...
(function () {
  ...
  const I18N = {
    es: {
      ...
      "login.eyebrow": "Acceso admin",
      "reviews.eyebrow": "Lo que dicen de nosotros",
      "reviews.title": "Reseñas reales, sin filtro",
      "reviews.cta": "★ Dejá tu reseña en Google",
      "footer.titular": "Titulares:",
      "footer.address": "Domicilio fiscal:",
      "dash.design.colors": "🎨 Colores de marca",
      "dash.design.colorsHint": "Cambiá la paleta del sitio en vivo. Se aplica a todos los componentes que usen variables CSS.",
      "dash.design.green": "Verde tabernero (principal)",
      "dash.design.greenDeep": "Verde profundo",
      "dash.design.sunset": "Naranja sunset (acento)",
      "dash.design.brass": "Dorado bronce (marquee)",
      "dash.design.cream": "Crema fondo",
      "dash.design.ink": "Texto principal",
      "dash.design.save": "Guardar paleta",
      "dash.design.reset": "Reset",
      "dash.design.typo": "✒️ Tipografía y escala",
      "dash.design.typoHint": "Ajustá tamaños y radios. Se aplica en vivo.",
      "dash.design.bodySize": "Tamaño base (px)",
      "dash.design.radius": "Radio tarjetas (px)",
      "dash.design.radiusLg": "Radio grande (px)",
      "dash.design.preview": "👁️ Vista previa rápida",
      "dash.design.live": "Los cambios viajan al sitio público inmediatamente. Tu navegador los recuerda.",
      "dash.consumption.wipeDemo": "🧹 Borrar 950 datos demo",
      "dash.pay.title": "💳 Pasarelas de pago e integraciones",
      "dash.pay.lead": "Conectá Capitán Beto con tu pasarela favorita para cobrar reservas, depósitos o takeaway. Las claves se guardan en tu navegador y NUNCA salen del dispositivo.",
      "dash.pay.active": "activas",
      "dash.pay.stripeDesc": "Tarjeta, Apple Pay, Google Pay · global",
      "dash.pay.deposit": "% depósito reserva",
      "dash.pay.save": "Guardar",
      "dash.pay.openDash": "Abrir dashboard",
      "dash.pay.redsysDesc": "Pasarela bancaria España · BBVA/Santander/CaixaBank",
      "dash.pay.paypalDesc": "Pago alternativo · turistas",
      "dash.pay.bizumDesc": "Pagos móvil instantáneos · España",
      "dash.pay.bizumNote": "Texto que aparece al cliente",
      "dash.pay.coverDesc": "Software de reservas líder en hostelería ES",
      "dash.pay.theforkDesc": "Marketplace de reservas TripAdvisor",
      "dash.pay.mcDesc": "Newsletter automática a clientes",
      "dash.pay.gaDesc": "Medición de tráfico y conversiones",
      "dash.pay.next": "🛣️ Próximos pasos para activar pagos reales",
      "dash.pay.s1": "Conseguí las claves de tu pasarela elegida.",
      "dash.pay.s2": "Activá el switch del proveedor y guardá las claves desde aquí.",
      "dash.pay.s3": "Para cobros en vivo necesitás un backend. Hoy las claves quedan en tu navegador.",
      "dash.pay.s4": "Cuando despleguemos backend, sólo intercambiamos el endpoint.",
    ...
    en: {
      ...
      "reviews.eyebrow": "What people say about us",
      "reviews.title": "Real reviews, unfiltered",
      "reviews.cta": "★ Leave a Google review",
      "footer.titular": "Owners:",
      "footer.address": "Fiscal address:",
      "dash.design.colors": "🎨 Brand colors",
      "dash.design.colorsHint": "Change the site palette live. Applies to all components using CSS variables.",
      "dash.design.green": "Tavern green (primary)",
      "dash.design.greenDeep": "Deep green",
      "dash.design.sunset": "Sunset orange (accent)",
      "dash.design.brass": "Brass gold (marquee)",
      "dash.design.cream": "Cream background",
      "dash.design.ink": "Body text",
      "dash.design.save": "Save palette",
      "dash.design.reset": "Reset",
      "dash.design.typo": "✒️ Typography & scale",
      "dash.design.typoHint": "Adjust sizes and radii. Applied live.",
      "dash.design.bodySize": "Base size (px)",
      "dash.design.radius": "Card radius (px)",
      "dash.design.radiusLg": "Large radius (px)",
      "dash.design.preview": "👁️ Quick preview",
      "dash.design.live": "Changes go to the public site immediately. Your browser remembers them.",
      "dash.consumption.wipeDemo": "🧹 Delete 950 demo records",
      "dash.pay.title": "💳 Payment gateways & integrations",
      "dash.pay.lead": "Connect Capitán Beto with your favourite gateway to charge reservations, deposits or takeaway. Keys are stored in your browser and NEVER leave the device.",
      "dash.pay.active": "active",
      "dash.pay.stripeDesc": "Card, Apple Pay, Google Pay · global",
      "dash.pay.deposit": "% reservation deposit",
      "dash.pay.save": "Save",
      "dash.pay.openDash": "Open dashboard",
      "dash.pay.redsysDesc": "Spanish banking gateway · BBVA/Santander/CaixaBank",
      "dash.pay.paypalDesc": "Alternative payment · tourists",
      "dash.pay.bizumDesc": "Instant mobile payments · Spain",
      "dash.pay.bizumNote": "Text shown to customer",
      "dash.pay.coverDesc": "Leading booking software for Spanish hospitality",
      "dash.pay.theforkDesc": "Restaurant booking marketplace by TripAdvisor",
      "dash.pay.mcDesc": "Automated newsletter to customers",
      "dash.pay.gaDesc": "Traffic and conversion measurement",
      "dash.pay.next": "🛣️ Next steps to activate real payments",
      "dash.pay.s1": "Get the keys from your chosen gateway.",
      "dash.pay.s2": "Toggle the provider switch and save the keys from here.",
      "dash.pay.s3": "For live charges you need a backend. Today keys stay in your browser.",
      "dash.pay.s4": "Once we deploy a backend, just swap the endpoint — gateways keep working.",
  ...
  function renderContentEditorPanel() {
    ...
    const fields = section.fields.map((f) => {
      ...
      // Divider — renders a section header, no value/selector
      if (f.type === "divider") {
        return `<div class="ce-divider">${f.label}</div>`;
      }
      let input;
      if (f.type === "longtext") {
